...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('hr.job-posts.create')); ?>"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $jobPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($jobPost->title); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($jobPost->location); ?></div>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <?php echo e($jobPost->company_name ?: 'Chưa cập nhật'); ?>
                                    ...
                                    <?php if($applicationCount > 0): ?>
                                        <a href="<?php echo e(route('hr.job-posts.applications', $jobPost)); ?>" 
                                           class="inline-flex items-center px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm font-medium hover:bg-indigo-200 transition">
                                            ...
                                            <?php echo e($applicationCount); ?> ứng viên
                                        </a>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">
                                    <?php echo e($jobPost->published_at?->format('d/m/Y') ?: '-'); ?>

                                </td>
                                <td class="px-6 py-4 text-right text-sm font-medium">
                                    <a href="<?php echo e(route('hr.job-posts.show', $jobPost)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Xem</a>
                                    <a href="<?php echo e(route('hr.job-posts.edit', $jobPost)); ?>" class="text-blue-600 hover:text-blue-900 mr-3">Sửa</a>
                                    <form action="<?php echo e(route('hr.job-posts.destroy', $jobPost)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e($application->applied_at->format('d/m/Y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\CLone Git\CVactive_ST5\resources\views/hr/job-posts/index.blade.php ENDPATH**/ ?>