<?php $__env->startSection('title', $jobPost->title . ' - CVactive'); ?>
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Link -->
        <div class="mb-6">
            <a href="<?php echo e(route('jobs.index')); ?>" class="text-indigo-600 hover:text-indigo-900 flex items-center gap-2">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="bg-indigo-600 px-6 py-6">
                <div class="flex items-start gap-4">
                    <?php if($jobPost->company_logo): ?>
                        <img src="<?php echo e(asset('storage/' . $jobPost->company_logo)); ?>" alt="<?php echo e($jobPost->company_name); ?>" class="w-20 h-20 object-contain rounded-lg bg-white p-2">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <div class="flex-1">
                        <h1 class="text-2xl font-bold text-white"><?php echo e($jobPost->title); ?></h1>
                        <p class="text-indigo-100 mt-1"><?php echo e($jobPost->company_name ?: 'Công ty chưa cập nhật'); ?></p>
            ...
            <div class="px-6 py-6">
                <!-- Company Info -->
                <?php if($jobPost->company_name || $jobPost->company_description): ?>
                    <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                        <h2 class="text-lg font-semibold text-gray-900 mb-2">Về công ty</h2>
                        <?php if($jobPost->company_name): ?>
                            <p class="font-medium text-gray-900"><?php echo e($jobPost->company_name); ?></p>
                        <?php endif; ?>
                        <?php if($jobPost->company_description): ?>
                            <p class="text-sm text-gray-600 mt-2"><?php echo e($jobPost->company_description); ?></p>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="prose max-w-none text-gray-600 whitespace-pre-wrap"><?php echo e($jobPost->description); ?></div>
                </div>

                <!-- Contact Info -->
                <?php if($jobPost->contact_email || $jobPost->contact_phone): ?>
                    <div class="mb-6 p-4 bg-green-50 rounded-lg border border-green-200">
                        <h2 class="text-lg font-semibold text-gray-900 mb-3">Thông tin liên hệ</h2>
                        <div class="space-y-2">
                            <?php if($jobPost->contact_email): ?>
                                <p class="flex items-center gap-2 text-gray-700">
                                    <svg class="w-5 h-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <a href="mailto:<?php echo e($jobPost->contact_email); ?>" class="text-green-700 hover:underline"><?php echo e($jobPost->contact_email); ?></a>
                                </p>
                            <?php endif; ?>
                            <?php if($jobPost->contact_phone): ?>
                                <p class="flex items-center gap-2 text-gray-700">
                                    <svg class="w-5 h-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                    <a href="tel:<?php echo e($jobPost->contact_phone); ?>" class="text-green-700 hover:underline"><?php echo e($jobPost->contact_phone); ?></a>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="text-sm text-gray-500 border-t pt-4">
                    <div class="flex flex-wrap gap-4">
                        <span>Đăng ngày: <?php echo e($jobPost->published_at?->format('d/m/Y')); ?></span>
                        <?php if($jobPost->expires_at): ?>
                            <span>Hết hạn: <?php echo e($jobPost->expires_at->format('d/m/Y')); ?></span>
                        <?php endif; ?>
                        <span>Lượt xem: <?php echo e($jobPost->views_count ?? 0); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow mt-6 overflow-hidden" id="apply-form">
            ...
            <div class="px-6 py-6">
                <?php if(auth()->guard()->check()): ?>
                    <form action="<?php echo e(route('jobs.apply', $jobPost)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" name="full_name" value="<?php echo e(old('full_name', auth()->user()->name)); ?>" required
                            ...
                            <div>
                                ...
                                <select name="cv_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                    ...
                                    <?php $__currentLoopData = $cvs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cv->id); ?>"><?php echo e($cv->title ?? 'CV #' . $cv->id); ?></option>
                        ...
                        <div>
                            ...
                            <textarea name="cover_letter" rows="4" 
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" 
                                placeholder="Giới thiệu về bản thân và lý do bạn phù hợp với vị trí này..."><?php echo e(old('cover_letter')); ?></textarea>
                        </div>
                ...
                <?php else: ?>
                    <div class="text-center py-8">
                        ...
                        <div class="mt-6 flex justify-center gap-4">
                            <a href="<?php echo e(route('login')); ?>" class="px-6 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition">
                                Đăng nhập
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="px-6 py-2 bg-gray-200 text-gray-800 font-medium rounded-lg hover:bg-gray-300 transition">
                                Đăng ký
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\CLone Git\CVactive_ST5\resources\views/jobs/show.blade.php ENDPATH**/ ?>