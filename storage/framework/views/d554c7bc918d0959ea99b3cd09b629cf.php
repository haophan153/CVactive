<?php $__env->startSection('title', 'Ứng viên: ' . $jobPost->title . ' - CVactive'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow mb-6 p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900"><?php echo e($jobPost->title ?? 'N/A'); ?></h1>
                    <p class="text-gray-600"><?php echo e($jobPost->company_name ?? 'N/A'); ?></p>
                ...
                <div class="text-right flex items-center gap-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-indigo-600"><?php echo e($applications->total()); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600"><?php echo e($applications->where('status', 'rejected')->count()); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow mb-6 p-4">
            <form method="GET" class="flex flex-wrap gap-4">
                ...
                <?php if(request()->anyFilled(['search', 'status'])): ?>
                    <a href="<?php echo e(route('hr.job-posts.applications', $jobPost)); ?>" class="px-6 py-2 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 transition">
                        Xóa lọc
                    </a>
                <?php endif; ?>
            </form>
                                ...
                                <tr class="hover:bg-gray-50">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <?php if($application->cv): ?>
                                                    <div class="text-xs text-gray-500">CV: <?php echo e($application->cv->title ?? '#'.$application->cv->id); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        ...
                                        <?php if($application->phone): ?>
                                            <div class="text-sm text-gray-500"><?php echo e($application->phone); ?></div>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="<?php echo e(route('hr.applications.show', $application)); ?>" class="text-indigo-600 hover:text-indigo-900">
                                            Xem chi tiết
                                        </a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\CLone Git\CVactive_ST5\resources\views/hr/applications/by-job.blade.php ENDPATH**/ ?>