...
<div class="flex items-center justify-between mb-5">
    <p class="text-sm text-gray-500"><?php echo e($posts->total()); ?> bài viết</p>
...
<div class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-5">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        <div class="flex-1 min-w-48">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Tìm tiêu đề..."
        ...
        <a href="<?php echo e(route('admin.blog.index')); ?>" class="px-4 py-2 bg-gray-100 text-gray-600 text-sm rounded-lg hover:bg-gray-200 transition">Reset</a>
        <?php endif; ?>
    </form>
</div>
...
<div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-5 py-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <img src="<?php echo e(asset('storage/'.$post->featured_image)); ?>" class="w-12 h-9 object-cover rounded flex-shrink-0">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <div class="min-w-0">
                                <p class="font-medium text-gray-900 truncate max-w-xs"><?php echo e($post->title); ?></p>
                                <p class="text-xs text-gray-400"><?php echo e($post->created_at->format('d/m/Y')); ?></p>
                            </div>
                        </div>
                    </td>
                    <td class="px-4 py-3 text-gray-500 text-xs"><?php echo e($post->category?->name ?? '—'); ?></td>
                    <td class="px-4 py-3 text-gray-500 text-xs"><?php echo e($post->author->name); ?></td>
                    <td class="px-4 py-3">
                        <span class="px-2.5 py-1 text-xs font-medium rounded-full <?php echo e($post->status === 'published' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'); ?>">
                            <?php echo e($post->status === 'published' ? 'Đã đăng' : 'Nháp'); ?>

                        </span>
                    </td>
                    <td class="px-4 py-3 text-gray-500 text-xs"><?php echo e(number_format($post->views_count)); ?></td>
                    <td class="px-5 py-3 text-right">
                        <div class="flex items-center justify-end space-x-2">
                            ...
                            <form action="<?php echo e(route('admin.blog.destroy', $post)); ?>" method="POST"
    ...
    <div class="px-5 py-4 border-t border-gray-100"><?php echo e($posts->links()); ?></div>
    <?php endif; ?>
</div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\CLone Git\CVactive_ST5\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>