...
<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <form method="POST" action="<?php echo e(route('hr.job-posts.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="6"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            placeholder="Mô tả chi tiết về công việc, yêu cầu, quyền lợi..." required><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="job_type" id="job_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <option value="full-time" <?php echo e(old('job_type') == 'full-time' ? 'selected' : ''); ?>>Toàn thời gian</option>
                                <option value="part-time" <?php echo e(old('job_type') == 'part-time' ? 'selected' : ''); ?>>Bán thời gian</option>
                                <option value="contract" <?php echo e(old('job_type') == 'contract' ? 'selected' : ''); ?>>Hợp đồng</option>
                                <option value="intern" <?php echo e(old('job_type') == 'intern' ? 'selected' : ''); ?>>Thực tập</option>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-1">
                            <div>
                                <input type="number" name="salary_min" value="<?php echo e(old('salary_min')); ?>"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    placeholder="Từ">
                            </div>
                            <div>
                                <input type="number" name="salary_max" value="<?php echo e(old('salary_max')); ?>"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    placeholder="Đến">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="company_description" id="company_description" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('company_description')); ?></textarea>
                            </div>
                            <div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="contact_email" id="contact_email" value="<?php echo e(old('contact_email', auth()->user()->email)); ?>"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
                ...
                <div class="mt-6 flex justify-end gap-4">
                    <a href="<?php echo e(route('hr.job-posts.index')); ?>" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                        Hủy
                    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\CLone Git\CVactive_ST5\resources\views/hr/job-posts/create.blade.php ENDPATH**/ ?>