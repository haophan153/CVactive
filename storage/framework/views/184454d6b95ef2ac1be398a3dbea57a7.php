...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> – CVactive</title>
...
<div class="min-h-full flex">
    ...
    <aside class="w-64 bg-gray-900 flex flex-col fixed inset-y-0 left-0 z-50 transition-transform duration-300"
        ...
        <div class="flex items-center h-16 px-5 border-b border-gray-700 flex-shrink-0">
            <a href="<?php echo e(auth()->user()->role === 'admin' ? route('admin.dashboard') : route('hr.job-posts.index')); ?>" class="flex items-center gap-2.5">
                <img src="<?php echo e(asset('storage/avatars/logo/logo.png')); ?>" alt="CVactive" class="h-7 w-auto object-contain brightness-0 invert">
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-4 space-y-1">
            ...
            <a href="<?php echo e(route($item['route'])); ?>"
                class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e($isActive ? 'bg-indigo-600 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white'); ?>">
    ...
    <div class="flex-1 flex flex-col lg:pl-64">
        ...
        <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 sticky top-0 z-30">
            <div class="flex items-center space-x-4">
                ...
                <h1 class="text-lg font-semibold text-gray-900"><?php echo $__env->yieldContent('page-title', 'Admin Panel'); ?></h1>
            </div>
...
<?php /**PATH C:\CLone Git\CVactive_ST5\resources\views/layouts/admin.blade.php ENDPATH**/ ?>